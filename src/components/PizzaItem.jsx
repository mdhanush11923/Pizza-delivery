...
export default function PizzaItem(props) {
  ...
  return (
    <Card isPressable className=" flex flex-col bg-foreground gap-4 pb-4 rounded-b-[10px] items-center shadow-sm" >
      <Card isPressable style={{ backgroundColor: props.color }} className={`w-[250px] justify-center text-center rounded-b-[30px] ${props.color} p-5 shadow-sm`}>
